...
DEFAULT_AREAS = Path("P:/155020_recover/WP1/R/data/from_gee/areas_recover")
DEFAULT_GRID = Path("P:/155020_recover/WP1/R/data/World_UTM_Grid_cleaned.geojson")
DEFAULT_OUTPUT = Path("data/ppi_gee")
