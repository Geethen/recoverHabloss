...
Z=norm.ppf(0.975)
lab=gpd.read_file('/data/P-Prosjekter2/155069_habloss/R/data/samples_habloss_recover_for_geethen.shp')
sd=pd.read_csv('recover_design.csv'); ar=pd.read_csv('recover_areas.csv')
